...
type ApiScriptByHashRequest struct {
	ctx context.Context
	ApiService *ScriptsApiService
	scriptHash string
}

func (r ApiScriptByHashRequest) Execute() (*Script, *http.Response, error) {
...
Returns the script corresponding to the specified script hash, if seen on-chain
 ...
 @return ApiScriptByHashRequest
*/
func (a *ScriptsApiService) ScriptByHash(ctx context.Context, scriptHash string) ApiScriptByHashRequest {
	return ApiScriptByHashRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return Script
func (a *ScriptsApiService) ScriptByHashExecute(r ApiScriptByHashRequest) (*Script, *http.Response, error) {
	var (
