...
type ApiAddressByTxoRequest struct {
	ctx context.Context
...
func (r ApiAddressByTxoRequest) Execute() (*UtxoAddress, *http.Response, error) {
...
Returns the address specified in the given transaction output
 ...
 @return ApiAddressByTxoRequest
*/
func (a *TransactionsApiService) AddressByTxo(ctx context.Context, txHash string, index int32) ApiAddressByTxoRequest {
	return ApiAddressByTxoRequest{
		ApiService: a,
		ctx: ctx,
		txHash: txHash,
...
//  @return UtxoAddress
func (a *TransactionsApiService) AddressByTxoExecute(r ApiAddressByTxoRequest) (*UtxoAddress, *http.Response, error) {
	var (
...
type ApiIogTxSubmitRequest struct {
	ctx context.Context
	ApiService *TransactionsApiService
	body *string
}
...
func (r ApiIogTxSubmitRequest) Body(body string) ApiIogTxSubmitRequest {
	r.body = &body
	return r
}

func (r ApiIogTxSubmitRequest) Execute() (string, *http.Response, error) {
...
Submit a signed and serialized transaction to the network. Interaction with this endpoint is identical to IOG's [Cardano Submit API](https://input-output-hk.github.io/cardano-rest/submit-api/) and will not be monitored by Maestro. See `POST /transactions` for transaction monitoring.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiIogTxSubmitRequest
*/
func (a *TransactionsApiService) IogTxSubmit(ctx context.Context) ApiIogTxSubmitRequest {
	return ApiIogTxSubmitRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *TransactionsApiService) IogTxSubmitExecute(r ApiIogTxSubmitRequest) (string, *http.Response, error) {
	var (
...
type ApiMaestroTxSubmitRequest struct {
	ctx context.Context
	ApiService *TransactionsApiService
	body *string
}
...
// CBOR encoded transaction
func (r ApiMaestroTxSubmitRequest) Body(body string) ApiMaestroTxSubmitRequest {
	r.body = &body
	return r
}

func (r ApiMaestroTxSubmitRequest) Execute() (string, *http.Response, error) {
...
Submit a signed and serialized transaction to the network. A transaction submited with this endpoint will be [monitored by Maestro](https://docs.gomaestro.org/docs/Getting-started/Monitor-a-transaction).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiMaestroTxSubmitRequest
*/
func (a *TransactionsApiService) MaestroTxSubmit(ctx context.Context) ApiMaestroTxSubmitRequest {
	return ApiMaestroTxSubmitRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *TransactionsApiService) MaestroTxSubmitExecute(r ApiMaestroTxSubmitRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiTxCborByTxHashRequest struct {
	ctx context.Context
	ApiService *TransactionsApiService
	txHash string
}

func (r ApiTxCborByTxHashRequest) Execute() (*TxCbor, *http.Response, error) {
...
Returns hex-encoded CBOR bytes of a transaction
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param txHash Hex encoded transaction hash
 @return ApiTxCborByTxHashRequest
*/
func (a *TransactionsApiService) TxCborByTxHash(ctx context.Context, txHash string) ApiTxCborByTxHashRequest {
	return ApiTxCborByTxHashRequest{
		ApiService: a,
		ctx: ctx,
		txHash: txHash,
...
// Execute executes the request
//  @return TxCbor
func (a *TransactionsApiService) TxCborByTxHashExecute(r ApiTxCborByTxHashRequest) (*TxCbor, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiUtxoByTxoRefRequest struct {
	ctx context.Context
	ApiService *TransactionsApiService
	txHash string
	index int32
...
func (r ApiUtxoByTxoRefRequest) ResolveDatums(resolveDatums bool) ApiUtxoByTxoRefRequest {
	r.resolveDatums = &resolveDatums
	return r
}

// Include the CBOR encodings of the transaction outputs in the response
func (r ApiUtxoByTxoRefRequest) WithCbor(withCbor bool) ApiUtxoByTxoRefRequest {
	r.withCbor = &withCbor
	return r
}

func (r ApiUtxoByTxoRefRequest) Execute() (*Utxo, *http.Response, error) {
...
Returns the specified transaction output of a transaction output reference
 ...
 @param txHash Hex encoded transaction hash
 @param index Transaction output index
 @return ApiUtxoByTxoRefRequest
*/
func (a *TransactionsApiService) UtxoByTxoRef(ctx context.Context, txHash string, index int32) ApiUtxoByTxoRefRequest {
	return ApiUtxoByTxoRefRequest{
		ApiService: a,
		ctx: ctx,
		txHash: txHash,
...
// Execute executes the request
//  @return Utxo
func (a *TransactionsApiService) UtxoByTxoRefExecute(r ApiUtxoByTxoRefRequest) (*Utxo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
